...
type MysqlReportRecorder struct {
	db *sql.DB
}

// NewReportRecorder is a ReportRecorder constructor
func NewMysqlReportRecorder(mysqlHost, mysqlUsername, mysqlPassword string) *MysqlReportRecorder {
	return &MysqlReportRecorder{}
}
...
func (rr *MysqlReportRecorder) StoreTopics(r *TextRazorResult) error {
